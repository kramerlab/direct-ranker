...
def plot(args):
    sig_adam_ranknet = np.load(f"{args.out_path}/sigmoid_MSLR10K_Adam_RankNet_list_of_ndcg.npy")
    tanh_adam_ranknet = np.load(f"{args.out_path}/tanh_MSLR10K_Adam_RankNet_list_of_ndcg.npy")
    sig_sgd_ranknet = np.load(f"{args.out_path}/sigmoid_MSLR10K_SGD_RankNet_list_of_ndcg.npy")
    tanh_sgd_ranknet = np.load(f"{args.out_path}/tanh_MSLR10K_SGD_RankNet_list_of_ndcg.npy")
